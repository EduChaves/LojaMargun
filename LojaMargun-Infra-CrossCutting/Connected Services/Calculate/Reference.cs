...
namespace Calculate
{
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Calculate.CalcPrecoPrazoWSSoap")]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface CalcPrecoPrazoWSSoapChannel : Calculate.CalcPrecoPrazoWSSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class CalcPrecoPrazoWSSoapClient : System.ServiceModel.ClientBase<Calculate.CalcPrecoPrazoWSSoap>, Calculate.CalcPrecoPrazoWSSoap
    {
        ...
        public System.Threading.Tasks.Task<Calculate.cResultado> CalcPrecoPrazoAsync(string nCdEmpresa, string sDsSenha, string nCdServico, string sCepOrigem, string sCepDestino, string nVlPeso, int nCdFormato, decimal nVlComprimento, decimal nVlAltura, decimal nVlLargura, decimal nVlDiametro, string sCdMaoPropria, decimal nVlValorDeclarado, string sCdAvisoRecebimento)
        {
        ...
        public System.Threading.Tasks.Task<Calculate.cResultado> CalcPrecoPrazoDataAsync(string nCdEmpresa, string sDsSenha, string nCdServico, string sCepOrigem, string sCepDestino, string nVlPeso, int nCdFormato, decimal nVlComprimento, decimal nVlAltura, decimal nVlLargura, decimal nVlDiametro, string sCdMaoPropria, decimal nVlValorDeclarado, string sCdAvisoRecebimento, string sDtCalculo)
        {
        ...
        public System.Threading.Tasks.Task<Calculate.cResultado> CalcPrecoPrazoRestricaoAsync(string nCdEmpresa, string sDsSenha, string nCdServico, string sCepOrigem, string sCepDestino, string nVlPeso, int nCdFormato, decimal nVlComprimento, decimal nVlAltura, decimal nVlLargura, decimal nVlDiametro, string sCdMaoPropria, decimal nVlValorDeclarado, string sCdAvisoRecebimento, string sDtCalculo)
        {
        ...
        public System.Threading.Tasks.Task<Calculate.cResultado> CalcPrecoAsync(string nCdEmpresa, string sDsSenha, string nCdServico, string sCepOrigem, string sCepDestino, string nVlPeso, int nCdFormato, decimal nVlComprimento, decimal nVlAltura, decimal nVlLargura, decimal nVlDiametro, string sCdMaoPropria, decimal nVlValorDeclarado, string sCdAvisoRecebimento)
        {
        ...
        public System.Threading.Tasks.Task<Calculate.cResultado> CalcPrecoDataAsync(string nCdEmpresa, string sDsSenha, string nCdServico, string sCepOrigem, string sCepDestino, string nVlPeso, int nCdFormato, decimal nVlComprimento, decimal nVlAltura, decimal nVlLargura, decimal nVlDiametro, string sCdMaoPropria, decimal nVlValorDeclarado, string sCdAvisoRecebimento, string sDtCalculo)
        {
        ...
        public System.Threading.Tasks.Task<Calculate.cResultado> CalcPrazoAsync(string nCdServico, string sCepOrigem, string sCepDestino)
        {
            return base.Channel.CalcPrazoAsync(nCdServico, sCepOrigem, sCepDestino);
        }
        
        public System.Threading.Tasks.Task<Calculate.cResultado> CalcPrazoDataAsync(string nCdServico, string sCepOrigem, string sCepDestino, string sDtCalculo)
        {
            return base.Channel.CalcPrazoDataAsync(nCdServico, sCepOrigem, sCepDestino, sDtCalculo);
        }
        
        public System.Threading.Tasks.Task<Calculate.cResultado> CalcPrazoRestricaoAsync(string nCdServico, string sCepOrigem, string sCepDestino, string sDtCalculo)
        {
            return base.Channel.CalcPrazoRestricaoAsync(nCdServico, sCepOrigem, sCepDestino, sDtCalculo);
        }
        
        public System.Threading.Tasks.Task<Calculate.cResultado> CalcPrecoFACAsync(string nCdServico, string nVlPeso, string strDataCalculo)
        {
            return base.Channel.CalcPrecoFACAsync(nCdServico, nVlPeso, strDataCalculo);
        }
        
        public System.Threading.Tasks.Task<Calculate.cResultadoObjeto> CalcDataMaximaAsync(string codigoObjeto)
        {
            return base.Channel.CalcDataMaximaAsync(codigoObjeto);
        }
        
        public System.Threading.Tasks.Task<Calculate.cResultadoServicos> ListaServicosAsync()
        {
            return base.Channel.ListaServicosAsync();
        }
        
        public System.Threading.Tasks.Task<Calculate.cResultadoServicos> ListaServicosSTARAsync()
        {
            return base.Channel.ListaServicosSTARAsync();
        }
        
        public System.Threading.Tasks.Task<Calculate.cResultadoModal> VerificaModalAsync(string nCdServico, string sCepOrigem, string sCepDestino)
        {
            return base.Channel.VerificaModalAsync(nCdServico, sCepOrigem, sCepDestino);
        }
        
        public System.Threading.Tasks.Task<Calculate.versao> getVersaoAsync()
        {
            return base.Channel.getVersaoAsync();
        }
        
        public System.Threading.Tasks.Task<Calculate.cResultado> calcPrazoNovoAsync(string nCdServico, string sCepOrigem, string sCepDestino, string sDtCalculo, string strVerificaRestricao)
        {
