...
namespace LojaMargun_Infrastructure.Migrations
{
    ...
    [Migration("20220329020838_config1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LojaMargun_Domain.Entities.Sale", b =>
                {
                    ...
                    b.Property<string>("AddressEndNumber")
                        .IsRequired()
                        .HasMaxLength(150)
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("LojaMargun_Domain.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LojaMargun_Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
